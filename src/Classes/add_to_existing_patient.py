...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_patientlist = QtWidgets.QComboBox(self.groupBox_2)
        self.comboBox_patientlist.setGeometry(QtCore.QRect(120, 60, 131, 25))
        self.comboBox_patientlist.setObjectName("comboBox_patientlist")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "Please select a user or create new patient"))
